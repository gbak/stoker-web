...
import com.gbak.sweb.client.dialog.AlertsSettingsDialog;
import com.gbak.sweb.client.dialog.GeneralMessageDialog;
import com.gbak.sweb.client.dialog.LogFileChooser;
import com.gbak.sweb.client.dialog.NewLogDialog;
import com.gbak.sweb.client.dialog.NewNoteDialog;
import com.gbak.sweb.client.dialog.handlers.AlertsSettingsDialogHandler;
import com.gbak.sweb.client.dialog.handlers.LogFileChooserHandler;
import com.gbak.sweb.client.dialog.handlers.NewLogDialogHandler;
import com.gbak.sweb.client.dialog.handlers.NewNoteDialogHandler;
import com.gbak.sweb.client.gauge.ProbeComponent;
import com.gbak.sweb.client.gauge.ProbeComponent.Alignment;
import com.gbak.sweb.client.graph.HighChartLineGraph;
import com.gbak.sweb.client.graph.StokerLineGraph;
import com.gbak.sweb.shared.model.Cooker;
import com.gbak.sweb.shared.model.CookerHelper;
...
*/                
    ...
    private ClickHandler stopLogsButtonClickHandler()
    {
       ClickHandler cl = new ClickHandler() {
        ...
        public void onClick(ClickEvent event)
        {
            ...
            m_stokerService.stopLog(m_cooker.getCookerName(), strLogName, new AsyncCallback<String>() {
                ...
                public void onSuccess(String result)
                {
                    ...
                    Window.open(GWT.getModuleBaseURL()+ "report" + "?logName=" + filename, "_blank", "enabled");
                }
            });
        }
    ...
    //    sGraphPanel.setHeight(new Integer(m_Height).toString() + "px");
     ...
     //   m_Height = 385;
        if ( m_alignment == Alignment.SINGLE)
        {
            m_Width = m_outerMostDecPanel.getOffsetWidth() - m_gaugePanelWidth - 40;
    ...
    public void updateGraph( SDataPoint sdp, boolean refresh)
    {
        setConnected(true);
        m_graphUpdate = true;
        if ( existsInActiveLog( sdp ) && m_graphStoker != null)
