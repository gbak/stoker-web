...
import com.gbak.sweb.client.dialog.AlertDialog;
import com.gbak.sweb.client.dialog.GeneralMessageDialog;
import com.gbak.sweb.client.dialog.LogFileChooser;
import com.gbak.sweb.client.dialog.LoginDialog;
import com.gbak.sweb.client.dialog.handlers.AlertDialogHandler;
import com.gbak.sweb.client.dialog.handlers.LogFileChooserHandler;
import com.gbak.sweb.client.dialog.handlers.LoginDialogHandler;
import com.gbak.sweb.client.gauge.ProbeComponent.Alignment;
import com.gbak.sweb.client.weather.WeatherComponent;
import com.gbak.sweb.client.widgets.Configuration;
import com.gbak.sweb.client.widgets.handlers.ConfigUpdateHandler;
...
import com.gbak.sweb.shared.model.CallBackRequestType.RequestType;
        ...
        m_stokerService.getDeviceConfiguration(new AsyncCallback<ConfigurationSettings>() 
         {
            ...
            public void onSuccess( ConfigurationSettings result)
            {
                ...
                Configuration ccfg = new com.gbak.sweb.client.widgets.Configuration(result) ;
...
*/   
    ...
    private void createCookers(CookerList cookerList, ArrayList<CookerComponent> componentList )
    {
       ...
       // moved manageCookerPanel() from here.
