...
package com.gbak.sweb.server.config.stoker;
...
import com.gbak.sweb.server.monitors.stoker.config.json.Blower;
import com.gbak.sweb.server.monitors.stoker.config.json.Sensor;
import com.gbak.sweb.server.monitors.stoker.config.json.Stoker;
import com.gbak.sweb.server.monitors.stoker.config.json.StokerOuter;
...
public class StokerHardwareDevice extends HardwareDeviceConfiguration
{
   ...
   // com.gbak.sweb.server.monitors.stoker.StokerPitMonitor.Config config;
   ...
   private synchronized void addConfig( String strInput, String strValue )
   {
    ...
    private synchronized boolean pullJSonConfig( boolean test)
    {
        ...
        } while ((bSuccess == false && iTry++ <= attempts ) );
