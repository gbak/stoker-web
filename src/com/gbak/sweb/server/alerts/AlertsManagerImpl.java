...
package com.gbak.sweb.server.alerts;
...
import com.gbak.sweb.server.alerts.conditions.ConnectionOrConfigChangeAlert;
import com.gbak.sweb.server.alerts.conditions.StokerAlarm;
import com.gbak.sweb.server.alerts.conditions.TempAlert;
import com.gbak.sweb.server.alerts.conditions.TimedAlert;
...
public class AlertsManagerImpl implements AlertManager
{
   ...
   public void init()
   {
      ...
      try
      {
         Class<AlertsBase> notifyClass = cl.loadClass("com.gbak.sweb.server.notify.delivery.NotifyByEmail");
