...
public class TempAlarmAlertModel extends AlertModel implements Serializable
{

   private static final long serialVersionUID = 934933626861181813L;
   private static final String m_TempAlertName = "Temp Alarm"; 
   
   public TempAlarmAlertModel()  { super( m_TempAlertName );  }
   
   public TempAlarmAlertModel( boolean b )
   {
